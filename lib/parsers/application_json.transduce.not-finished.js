...
proto.push = function() {
  var data = {value: this.value, key: this.key, mode: this.mode};
...
module.exports = function(options) {
  function JSONTransduce(options, xf) {
    ...
    parser.onData = function(data) {
      ...
      if (mode === OBJECT) {
        parsedChunk = {};
        parsedChunk[data.key] = data.value;
      } else if (mode === ARRAY) {
        parsedChunk = data.value;
      }

//      var parsedChunk = {};
//      if (currentKey) {
//        parsedChunk[currentKey] = value;
//      } else {
//        parsedChunk = value;
//      }
//
//      parsedChunk['@level'] = level;
//
...
//
//      if (!currentKey) {
//        currentKey = that.string;
//      }
//      var key = that.key;
//      currentKeys[level] = key;
//
//      var currentKey = key || currentKeys[level - 1];
//
//      var parsedChunk = {};
//      if (currentKey) {
//        parsedChunk[currentKey] = value;
...
//
////      if (stopper[level] < 4) {
////        console.log('stack length: ' + String(level));
////        console.log('this');
////        console.log(this);
////        console.log('value');
////        console.log(value);
